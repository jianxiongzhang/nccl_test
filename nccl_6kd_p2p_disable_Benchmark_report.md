...
```text
# --- 执行命令 ---
ssh R6KD-CX8aaS-GPU-11 'export NCCL_IB_ADAPTIVE_ROUTING=0 NCCL_IB_OOO_RQ=0 NCCL_IB_RECEIVER_SIDE_MATCHING_SCHEME=0 NCCL_IB_PREPOST_RECEIVE_WORK_REQUESTS=0; /root/xuyj/run_zjx.sh'
...
```text
# --- 执行命令 ---
ssh R6KD-CX8aaS-GPU-11 'export NCCL_IB_ADAPTIVE_ROUTING=1 NCCL_IB_OOO_RQ=0 NCCL_IB_RECEIVER_SIDE_MATCHING_SCHEME=0 NCCL_IB_PREPOST_RECEIVE_WORK_REQUESTS=0; /root/xuyj/run_zjx.sh'
...
```text
# --- 执行命令 ---
ssh R6KD-CX8aaS-GPU-11 'export NCCL_IB_ADAPTIVE_ROUTING=1 NCCL_IB_OOO_RQ=1 NCCL_IB_RECEIVER_SIDE_MATCHING_SCHEME=1 NCCL_IB_PREPOST_RECEIVE_WORK_REQUESTS=1; /root/xuyj/run_zjx.sh'
